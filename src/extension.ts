...
async function executeExplainAction(
	...
	const systemPrompt = `You are an expert software engineer analyzing the provided code selection within the context of the full file. Language: ${languageId}. File: ${fileName}.`;
