...
export const DEFAULT_OPTIMIZATION_SETTINGS = {
	[OPTIMIZATION_SETTINGS_KEYS.MAX_HEURISTIC_FILES_TOTAL]: 15,
	[OPTIMIZATION_SETTINGS_KEYS.MAX_SAME_DIRECTORY_FILES]: 10,
	[OPTIMIZATION_SETTINGS_KEYS.MAX_DIRECT_DEPENDENCIES]: 5,
	[OPTIMIZATION_SETTINGS_KEYS.MAX_REVERSE_DEPENDENCIES]: 5,
	[OPTIMIZATION_SETTINGS_KEYS.MAX_CALL_HIERARCHY_FILES]: 5,
};
