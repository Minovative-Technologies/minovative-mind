...
export async function generateLightweightPlanPrompt(
	...
	const prompt = `Given the following AI response, generate a concise '/plan' command request, using "/plan" infront of each one, for the user to review. Focus on the core actionable intent and summary. Do not include any extraneous text.
