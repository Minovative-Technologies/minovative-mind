...
- **Comprehensive Understanding:** The AI intelligently considers your active file content, selected code, relevant diagnostics (warnings/errors) from VS Code, chat history, and the overall project structure.
